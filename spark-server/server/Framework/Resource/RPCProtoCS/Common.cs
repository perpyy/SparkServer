...
// source: D:\csharpapps\SparkServer\spark-server\server\Framework\Tools\sproto2cs\..\\..\\Resource\\RPCProtoSchema\\Common.sproto
...
namespace NetSprotoType { 
	public class DispatchData : SprotoTypeBase {
		...
		private Int64 _tcpObjectId; // tag 2
		public Int64 tcpObjectId {
			get { return _tcpObjectId; }
			set { base.has_field.set_field (2, true); _tcpObjectId = value; }
		}
		public bool HasTcpObjectId {
			get { return base.has_field.has_field (2); }
		}

		public DispatchData () : base(max_field_count) {}

		public DispatchData (byte[] buffer) : base(max_field_count, buffer) {
			this.decode ();
		}
		...
		protected override void decode () {
			...
			while (-1 != (tag = base.deserialize.read_tag ())) {
				...
				case 1:
					...
					break;
				case 2:
					this.tcpObjectId = base.deserialize.read_integer ();
					break;
				default:
		...
		public override int encode (SprotoStream stream) {
			...
			if (base.has_field.has_field (2)) {
				base.serialize.write_integer (this.tcpObjectId, 2);
			}
