            ...
            while(transferedBytes > 0)
            {
                ...
                else
                {
                    if (m_readNum == -1)
                    {
                        ...
                        {
                            m_onSessionError(m_opaque, m_sessionId, (int)SocketError.Disconnecting, "May be this is a illegal connection");
                            break;
                        }
                    }
                    else if (m_readNum == 0)
                    {
                        ...
                        if (transferedBytes >= m_packetSize)
                        {
                            ...
                            m_onReadPacketComplete(m_opaque, m_sessionId, transferBuffer, m_packetSize);
